...
def visual():
    return render_template('visual.html',template_folder='./templates',static_folder='./css')

@app.route('/sms/', methods=['POST'])
def sms():
    res=cal(request.form)
    try:
        resp =  sendSMS('UwYs16dD3zM-DKuzZKQYolAJkoba1j0BmRGompsNRs', '6304803525', 'TXTLCL', 'Severe acceident')
        print (resp)
